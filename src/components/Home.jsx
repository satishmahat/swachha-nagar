...
<section class="bg-center bg-no-repeat bg-[url('src/assets/photo-1650638987536-6fbcb9bc6085.jpeg')] bg-gray-500 bg-blend-multiply">
    <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56 bg-transparent">
        ...
        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 bg-transparent">
            <a href="/join" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white lg:text-xl rounded-2xl bg-[#009600] hover:bg-[#55b355] focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                Join Us Now
